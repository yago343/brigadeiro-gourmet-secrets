...
const BrigadeiroFlavors = () => {
  const flavors = [
    { name: "Mojito", image: brigadeiroMojito },
    { name: "Mojito 1", image: brigadeiroMojito1 },
    { name: "Mojito 2", image: brigadeiroMojito2 },
    { name: "Mojito 3", image: brigadeiroMojito3 },
    { name: "Mojito 4", image: brigadeiroMojito4 },
    { name: "Mojito 5", image: brigadeiroMojito5 },
    { name: "Mojito 6", image: brigadeiroMojito6 },
    { name: "Mojito 7", image: brigadeiroMojito7 },
    { name: "Mojito 8", image: brigadeiroMojito8 },
    { name: "Mojito 9", image: brigadeiroMojito9 },
    { name: "Mojito 10", image: brigadeiroMojito10 },
    { name: "Mojito 11", image: brigadeiroMojito11 },
    { name: "Mojito 12", image: brigadeiroMojito12 }
  ];
