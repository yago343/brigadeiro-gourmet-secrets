        ...
        <div className="container mx-auto px-0">
          ...
          <div className="text-center mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <Button variant="cta" size="lg" className="text-xl rounded-full shadow-2xl py-[6px] px-0 mx-0 cta-pulse hover:animate-none hover-scale">
          ...
          <div className="text-center">
            ...
            <Button variant="cta" size="lg" className="text-2xl rounded-full shadow-2xl my-0 py-0 px-0 mx-0 cta-bounce hover:animate-none hover-scale">
