...
const TestimonialCarousel = () => {
  const testimonials = [
    { src: testimonial1, alt: "Depoimento 1" },
    { src: testimonial2, alt: "Depoimento 2" },
    { src: testimonial3, alt: "Depoimento 3" },
    { src: testimonial4, alt: "Depoimento 4" },
    { src: testimonial5, alt: "Depoimento 5" },
    { src: testimonial6, alt: "Depoimento 6" }
  ];
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <div className="mt-4 w-full bg-muted-foreground/20 rounded-full h-1 overflow-hidden">
        <div 
          className="h-full bg-gold-elegant transition-all duration-300 ease-out"
